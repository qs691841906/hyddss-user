...
@Component
@RabbitListener(queues = Constant.QUE_ORDERUSR_ADD)
public class OrderUserAdd {
	...
	private static final  Logger log = LoggerFactory.getLogger(OrderUserAdd.class);
	...
	public void process(String message) {
		...
		if(null != userTask){
			...
			String result = WebClientUtils.webClient("http://10.11.108.69:8880/DBMS/webservices/OrderCustomersAddService?wsdl", xmlInfo, "orderCustomersAdd");
			if (result.toUpperCase().contains(Constant.REPLYINFO_SUCCESS)) {
